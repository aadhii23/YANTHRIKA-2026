      ...
      <section className="events-page-section">
        <div className="auto-container">
          <div className="events-header reveal">
            <div>
              <span style={{ fontFamily:'var(--font-heading)', fontSize:11, letterSpacing:'0.25em', textTransform:'uppercase', color:'var(--main-color)' }}>6 Events</span>
            ...
            {EVENTS.map((e, i) => (
              <div key={e.slug} className={`event-card reveal delay-${(i % 3) + 1}`}>
                <div className="event-card-img">
                  ...
                  <span className="event-card-cat">Non-Technical</span>
                </div>
