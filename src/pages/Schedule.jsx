...
const DAYS = [
  { day:1, label:'Day 1', date:'April 16, 2026', slots:[
    { time:'8:30 AM',  label:'Registraions',  type:'allotment',      desc:'Participant check-in, team verification and badge distribution.' },
    { time:'09:00 AM', label:'Inauguration & Keynote Address',       type:'ceremony',     desc:'Grand opening, lamp lighting and chief guest address.' },
    { time:'10:00 AM',  label:'IT-Quiz',                      type:'technical',         desc:'Head-to-head arguments on modern tech and industry shifts.' },
    { time:'10:00 AM',  label:'EXHIBITION',  type:'workshop',      desc:'Live project demonstrations and innovative tech showcases.' },
    { time:'2:00 PM',  label:'CODING & DEBUGGING',   type:'technical', desc:'Algorithmic challenges, live coding and rapid bug fixing.' },
    { time:'3:30 PM',  label:'IT DEBATE',   type:'technical',      desc:'Clash of ideas on emerging tech and digital ethics.' },
    { time:'5:00 PM',  label:'BATTLEGROUNDS MOBILE INDIA',   type:'non-technical',      desc:'Squad up, survive the drop, and claim ultimate victory.' },
  ]},
  { day:2, label:'Day 2', date:'April 17, 2026', slots:[
    { time:'9:00 AM',  label:'Registraions',  type:'allotment',      desc:'Participant check-in, team verification and badge distribution.' },
    { time:'10:00 AM', label:'TREASURE HUNT',   type:'non-technical',      desc:'Decode cryptic clues, solve puzzles and uncover the hidden prize.' },
    { time:'10:00 AM',  label:'PHOTOGRAPHY',                      type:'non-technical',         desc:'Find the perfect angle, capture the moment and tell a visual story.' },
    { time:'10:00 AM',  label:'VLOGGING',    type:'non-technical', desc:'Dynamic event coverage, creative storytelling and on-the-fly editing.' },
    { time:'2:00 PM',  label:'START-UP PITCH',             type:'non-technical',      desc:'Pitch innovative ideas, outline business models and win over the judges.' },
    { time:'5:30 PM',  label:'ESCAPE ROOM', type:'non-technical',      desc:'Decode the mystery, outsmart the traps and secure your exit under pressure.' },
    { time:'5:30 PM',  label:'FREEFIRE', type:'non-technical',      desc:'Fast-paced survival, strategic drops, and intense 10-minute combat rounds.' },
