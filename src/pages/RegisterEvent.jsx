...
export default function RegisterEvent() {
  ...
  // Hard-closed events — show closed screen instead of form
              ...
              <form className="contact-form reg-form" onSubmit={handleSubmit} noValidate>
                ...
                <div className="form-row">
                  <Field label="College / University" required error={errors.college}>
                    ...
                    />
                    {snpsuBlocked && (
                      <span className="field-err" style={{ display: 'block', marginTop: 6 }}>
                        ⚠ Registrations are closed for Sapthagiri NPS University students. Students from other colleges can still register.
                      </span>
                    )}
                  </Field>
                  {isTeam && (
