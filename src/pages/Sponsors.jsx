      ...
      <section className="sponsors-page">
        <div className="auto-container">
          ...
          <div className="sponsors-current reveal">
            <div className="sponsors-current__hdr">
              <span className="sponsors-current__label">Our Sponsors</span>
              <div className="sponsors-current__line" />
            </div>
            <div className="sponsors-logos-grid">
              {SPONSORS.map((sponsor, i) => (
                <a
                  ...
                  title={sponsor.name}
                >
                  <div className="sponsor-logo-card__img-wrap">
                    <img
                  ...
                  <div className="sponsor-logo-card__name">{sponsor.name}</div>
                  <div className="sponsor-logo-card__shine" />
                </a>
              ))}
            </div>
          </div>
          ...
          <div className="sponsors-cta reveal">
            ...
            <div className="sponsors-cta-btns">
              <a href="https://github.com/aadhii23/YANTHRIKA-2026/releases/download/v1.0/YANTHRIKA-BROCHURE.pdf" target="_blank" rel="noopener noreferrer" className="btn-style-one">
